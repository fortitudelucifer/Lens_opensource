...
│   │  │ 身份证/CHAT_APP│  │ other_names│  │ 历史人物   │  │ 置信度 1.0 │     │  │
│   │  └────────────┘  └────────────┘  └────────────┘  └────────────┘     │  │
│   └──────────────────────────────────────────────────────────────────────┘  │
│                                    │                                         │
│                                    ▼                                         │
...
# 检测 PII
text = "我的电话是PHONE_PLACEHOLDER，邮箱是test@EMAIL_PLACEHOLDER.com"
...
# 输出:
# [regex] PHONE: 'PHONE_PLACEHOLDER'
# [regex] EMAIL: 'test@EMAIL_PLACEHOLDER.com'
```
