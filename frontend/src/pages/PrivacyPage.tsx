      ...
      <div className="max-w-3xl mx-auto px-6 py-10 space-y-8">
        ...
        <div className="relative rounded-2xl overflow-hidden">
          ...
          <div className="relative p-8">
            ...
            <p className="text-xs text-[var(--text-muted)] mt-2">{t('privacy.lastUpdated')}</p>
          </div>
        </div>

        {/* §1 非诊断声明 */}
        <Section icon={<Sparkles className="w-4 h-4 text-amber-500" />} title={t('privacy.disclaimerTitle')} accent="amber">
        ...
        <Section icon={<Server className="w-4 h-4 text-emerald-500" />} title={t('privacy.dataLifecycleTitle')} accent="emerald">
          ...
          <h3 className="font-semibold text-sm mt-3">{t('privacy.processTitle')}</h3>
          <ul className="list-disc pl-5 space-y-1">
          ...
          <h3 className="font-semibold text-sm mt-3">{t('privacy.storeTitle')}</h3>
          <ul className="list-disc pl-5 space-y-1">
          ...
          <h3 className="font-semibold text-sm mt-3">{t('privacy.deleteTitle')}</h3>
          <ul className="list-disc pl-5 space-y-1">
        ...
        {/* §4 用户权利 */}
        <Section icon={<Trash2 className="w-4 h-4 text-red-500" />} title={t('privacy.userRightsTitle')} accent="red">
          <ul className="list-disc pl-5 space-y-1">
        ...
        <div className="text-center py-6 text-xs text-[var(--text-muted)]">
          <p>{t('privacy.footer.line1')}</p>
          <p className="mt-1">{t('privacy.footer.line2')}</p>
        </div>
      </div>
    </div>
  )
